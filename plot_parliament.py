...
def plot_parliament(parliament):
    ...
    if parliament_stance and cabinet_stance:
        ...
        ax.plot(eco_soc_mean[0], eco_soc_mean[1], "X", color=CB_color_cycle[2], label="Parliamentary Mean")
        ax.plot(eco_soc_median[0], eco_soc_median[1], "X", color=CB_color_cycle[5], label="Parliamentary Median")
        ...
        plt.savefig(f"{save_dir}/{country}_{elec_year}")
